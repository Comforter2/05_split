...
# Model fitting
spp_rcbd_mix_mod = lmer(yield_kgha ~ krate_kgha*nrate_kgha + (1|block/krate_kgha),
                        data = spp_rcbd_dfw) # this is to nest block into the whole plot factor that is potassium rate
